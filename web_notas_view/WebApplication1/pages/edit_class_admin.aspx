<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="edit_class_admin.aspx.cs" Inherits="WebApplication1.pages.edit_class_admin" %>
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li  class="active"><a href="edit_class_admin.aspx"> <span class="glyphicon glyphicon-chevron-right"></span> Editar / Desativar Turma <span class="sr-only">(current)</span></a></li>
