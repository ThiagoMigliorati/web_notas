<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cad_teacher_admin.aspx.cs" Inherits="WebApplication1.pages.cad_teacher_admin" %>
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="cad_teacher_admin.aspx"><span class="glyphicon glyphicon-chevron-right"></span> Cadastrar Professor <span class="sr-only">(current)</span></a></li>
