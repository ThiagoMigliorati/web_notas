<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="list_class.aspx.cs" Inherits="WebApplication1.pages.list_class" %>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                ...
                <p class="text-center"><a href="index.aspx" class="btn btn-default btn-sm">Voltar</a></p>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
