<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cad_class_admin.aspx.cs" Inherits="WebApplication1.pages.cad_class_admin" %>
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="cad_class_admin.aspx"><span class="glyphicon glyphicon-chevron-right"></span> Cadastrar Turma  <span class="sr-only">(current)</span></a></li>
